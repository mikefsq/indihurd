...
func New(cfg Config, kit *binding.Kit) *Rotator {
	d := &Rotator{kit: kit}
...
func (d *Rotator) Description() string { return d.kit.DescriptionText() }

// DriverInfo is the bridge and driver identity string.
func (d *Rotator) DriverInfo() string { return d.kit.DriverInfoText(d.Version) }
